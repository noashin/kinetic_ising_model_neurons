...
def EP_single_neuron(activity, ro, n):
    '''
...
def main():
    ...
    '''plt.plot([J.min(), J.max()], [J.min(), J.max()], 'k')
    plt.plot(J.flatten(), J_est_3.flatten(), 'o')
    plt.show()

    plt.plot([J.min(), J.max()], [J.min(), J.max()], 'k')
    plt.plot(J.flatten(), J_est_2.flatten(), 'o')
    plt.show()
    plt.plot([J.min(), J.max()], [J.min(), J.max()], 'k')
    plt.plot(J.flatten(), J_est_4.flatten(), 'o')
    plt.show()'''
